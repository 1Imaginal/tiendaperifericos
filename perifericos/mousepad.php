...
<head>
    <?php
      ...
      $query = "SELECT m.modelo, f.nombre AS fabricante, m.precio FROM mousepad m INNER JOIN fabricante f ON f.id=m.idFab";
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="mynavbar">
            <ul class="navbar-nav me-auto">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="mousepad.php">Mousepad</a>
              </li>
            </ul>
            <form class="d-flex">
